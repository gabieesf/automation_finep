...
Funcionalidade: Filtros
  ...
  Cenario: Filtrar por:  Empresas, Empresas | Startup, Gestores de Fundos de Investimento em Participações
    ...
    E a pagina deve exibir o texto: "CHAMADA PÚBLICA PARA A SELEÇÃO DE GESTOR E ADMINISTRADOR PARA O FUNDO DE INVESTIMENTO EM PARTICIPAÇÕES FINEP STARTUP 1 – FIP FINEP STARTUP 1"
