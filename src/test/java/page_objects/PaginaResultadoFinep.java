...
public class PaginaResultadoFinep extends BasePage {
   ...
   private By descriptionCenario3 = By.cssSelector("#componente > div > div.group.desc > div > p:nth-child(1)");
   ...
   private By descriptionResult = By.cssSelector("#componente > div > div.group.desc > div > p:nth-child(1)");
    ...
    public String getValidaDescricaoCenario3() {
        waitElementVisible(titleResult, 5);
        String descricaoTexto = driver.findElement(descriptionCenario3).getText();
        return descricaoTexto;
    }
}
