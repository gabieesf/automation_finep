...
public class FiltrosChamadasPublicasSteps extends BaseSteps {
    ...
    @Entao("a pagina deve exibir o texto: {string}")
    public void aPaginaDeveExibirOTexto(String descricaoEsperada) {
        String msgTela = paginaResultado.getValidaDescricaoCenario3();
        Assert.assertEquals(descricaoEsperada, msgTela);
        screenshot();
    }
